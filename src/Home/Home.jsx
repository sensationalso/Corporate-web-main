            ...
            <div className='Corporate'>
                ...
                <section className='service py'>
                    <div className='container'>
                        <div className='row '>
                            ...
                            <div className='img2 img-fluid w-50'>
                            ...
                            <div className='img1 img-fluid w-50'>
                ...
                <section className='project py'>
                    <div className='project-title'>
                        <span className=''>Latest Project & Case</span>
                        <h1>Let’s Looks Our Global Projects.</h1>
                    </div>
                    <div className='project-image d-flex'>
                        <div className='img1 img-fluid w-50 col-3'>
                            <img src={Service2} alt='Service2' />
                            <div class="pro-title">
                        ...
                        <div className='img2 img-fluid w-50 col-3'>
                            <img src={Service2} alt='Service2' />
                            <div class="pro-title">
                                <div class="pro-content">
                                    <h2>Technical Analysis</h2>
                        ...
                        <div className='img3 img-fluid w-50 col-3'>
                            <img src={Service2} alt='Service2' />
                            <div class="pro-title">
                                <div class="pro-content">
                                    <h2>Technical Analysis</h2>
                        ...
                        <div className='img4 img-fluid w-50 col-3'>
                            <img src={Service2} alt='Service2' />
                            <div class="pro-title">
                                <div class="pro-content">
                                    <h2>Technical Analysis</h2>
